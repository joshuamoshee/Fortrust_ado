...
import { Users, UploadCloud, Download, Flame, Thermometer, Snowflake, Plus, FileText, FileSpreadsheet, CheckCircle2, Loader2, X, AlertCircle, Search, Filter } from "lucide-react";

export default function MarketingDashboard() {
  const [leads, setLeads] = useState<any[]>([]);
  const [activeTab, setActiveTab] = useState("database"); // 'database' | 'import' | 'manual'
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto space-y-6 font-sans antialiased">
      ...
      {/* VIEW 3: MANUAL ENTRY */}
      {activeTab === "manual" && (
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 max-w-xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
